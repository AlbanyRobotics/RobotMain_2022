...
// The robot's subsystems
    ...
    public final LiftArm m_liftArm = new LiftArm();
...
final XboxControllerAxisButton left_trigger = new XboxControllerAxisButton(LiftController, XboxController.Axis.kLeftTrigger.value);
left_trigger.whileHeld(new LiftArmDown( m_liftArm ) ,true);

final XboxControllerAxisButton right_trigger = new XboxControllerAxisButton(LiftController, XboxController.Axis.kRightTrigger.value);
right_trigger.whileHeld(new LiftArmUp( m_liftArm) ,true);
