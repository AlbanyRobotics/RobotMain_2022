...
//Do NOT TOUCH
    final JoystickButton rightTrigger = new JoystickButton(xboxController1, XboxController.Button.kB.value);        
rightTrigger.whileHeld(new SpinFlywheels( m_shootBall ) ,true);
    SmartDashboard.putData("rightTrigger",new SpinFlywheels( m_shootBall ) );
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=BUTTONS
// Create some buttons
final JoystickButton xbutton = new JoystickButton(xboxController1, XboxController.Button.kX.value);        
xbutton.whileHeld(new Survey( m_ballSurvey ) ,true);
    SmartDashboard.putData("x-button",new Survey( m_ballSurvey ) );
...
final JoystickButton leftTrigger = new JoystickButton(xboxController1, XboxController.Button.kA.value);        
...
final JoystickButton xboxButton1 = new JoystickButton(xboxController1, XboxController.Button.kLeftStick.value);        
xboxButton1.whenPressed(new SpinFlywheels( m_shootBall ) ,true);
