...
private final Joystick joystick1 = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    m_driveTrain.setDefaultCommand (new DriveWithJoysticks (() -> -joystick1.getRawAxis(1), () -> -joystick1.getRawAxis(4), m_driveTrain ));
...
// Create some buttons
final JoystickButton rightTrigger = new JoystickButton(joystick2, 3);        
rightTrigger.whenPressed(new SpinFlywheels( m_shootBall ) ,true);
    SmartDashboard.putData("Right Trigger",new SpinFlywheels( m_shootBall ) );

final JoystickButton leftTrigger = new JoystickButton(joystick2, 2);        
leftTrigger.whileHeld(new IntakeSpinning( m_intakeSpin ) ,true);
    SmartDashboard.putData("Left Trigger",new IntakeSpinning( m_intakeSpin ) );
